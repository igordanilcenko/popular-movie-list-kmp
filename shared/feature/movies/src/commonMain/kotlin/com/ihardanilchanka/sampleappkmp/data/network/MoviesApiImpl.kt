...
class MoviesApiImpl(
    ...
    override suspend fun getPopularMovieList(apiKey: String, page: Int): MovieListResponse =
        httpClient.get("movie/popular") {
            parameter("api_key", apiKey)
            parameter("page", page)
        }.body()

    override suspend fun getMovieReviews(movieId: Int, apiKey: String): ReviewListResponse =
        httpClient.get("movie/$movieId/reviews") {
            parameter("api_key", apiKey)
        }.body()

    override suspend fun getSimilarMovieList(movieId: Int, apiKey: String): MovieListResponse =
    ...
    override suspend fun getGenreList(apiKey: String): GenreListResponse =
